export const aboutInfo = {
  ...
  <p>
    ...
    who took it from the FIFA  <a href="https://www.kaggle.com/datasets/abecklas/fifa-world-cup?resource=download&select=WorldCups.csv">World Cup Archive website</a>.
    Data for players was originally collected by Kaggle user Stefano Leone, 
    who extracted it from the  <a href="https://www.kaggle.com/datasets/stefanoleone992/fifa-22-complete-player-dataset?select=players_22.csv">video game FIFA 22</a>.
    Country boundary shapefile for thr choropleth map of number of players was obtained from <a href="https://datahub.io/core/geo-countries">DataHub</a> and <a href="https://geoportal.statistics.gov.uk/datasets/ons::countries-december-2021-uk-bgc/explore?location=52.905565%2C-1.566814%2C6.12&showTable=true">GeoPortal</a>
    To see the processed data files we used, please visit the <a href="https://github.com/ehubbartt/fifa-success-map">GitHub Project</a>
  </p>,
  ...
  <p>
    ...
    Course GitHub for Professor Zhao's GEOG458 class is <a href="https://github.com/jakobzhao/geog458">here</a>. 
  </p>
};
